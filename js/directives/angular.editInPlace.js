...
App.directive( 'editInPlace', function() {
	return {
		...
		template: '<span class="scoreName glyphicon glyphicon-pencil" ng-click="edit()"></span>\n' +
			'<div class=\'col-xs-6\'><input class="form-control" ng-model="score.student" placeholder="Student Name"></div>\n' +
			...
			'<div class=\'col-xs-1\' ng-class=""><span class="glyphicon glyphicon-floppy-save" ng-click="editing = false"></span></div>\n',
